...
parser.add_argument('--ckpoint', type=str, default='./ckpoint/', help='location of model checkpoints')
...
parser.add_argument('--scale', type=int, default=14, help='number of patches')
parser.add_argument('--miss_rate', type=float, default=0.3, help='missing rate')
parser.add_argument('--miss_type', type=str, default="MAR", help='missing type')
parser.add_argument('--data_cache', type=str, default="data/", help='data cache')
parser.add_argument('--omga', type=float, default=0, help='weight of fusion param')
parser.add_argument('--a_layers', type=int, default=4, help='layers for fine branch')
parser.add_argument('--b_layers', type=int, default=4, help='layers for coarse branch')
parser.add_argument('--e_layers', type=int, default=2, help='num of the shared backbone layers')
...
parser.add_argument('--auxi_type', type=str, default='complex', help='auxi loss type')
...
parser.add_argument('--noise_type', type=str, default='sin', help='noise type')
...
parser.add_argument('--temperature', type=float, default=0.1, help='Temperature parameter for analysis')
parser.add_argument('--align_rate', type=float, default=1.0, help='Alignment rate')
